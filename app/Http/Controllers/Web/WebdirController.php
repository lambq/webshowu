...
class WebdirController extends Controller
{
    ...
    function index(Request $request)
    {
        ...
        return view('web/webdir_index',$data);
    }
    /**
     * 站点列表
     */
    ...
    {
        if($request->id){
            $cate = Categorie::where('cate_id', $request->id)->select('cate_arrchildid','cate_name','cate_keywords','cate_description')->first();
        ...
        $data['site_nav'] = 'webdir';
        return view('web/webdir_lists',$data);
    }
    /**
     * 站点内容页
     */
    function info(Request $request)
    {
        ...
        if($websites){
            ...
            return view('web/webdir_info',$data);
        }else{
            return redirect('/');
        }
    }
