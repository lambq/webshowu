...
class HomeController extends Controller
{
    ...
    public function edit_site_get(Request $request)
    {
        ...
        $data['web'] = $web;
        return view('web.site_edit',$data);
    }
    /**
     * 站点编辑
     *
